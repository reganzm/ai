...
root_path="J:/nlp/chapter4/2TF-IDF/code"
djclass_path="-Djava.class.path="+root_path+os.sep+"module"+os.sep+"hanlp"+os.sep+"hanlp-1.5.0.jar;"+root_path+os.sep+"module"+os.sep+"hanlp"
