...
class CnnModel:
    ...
    def predict(self, data):
        ...
        feed_dict = {
            self.model.input_x: kr.preprocessing.sequence.pad_sequences([datas], self.config.seq_length),
...
if __name__ == '__main__':
    ...
    test_sets = np.load('./datas/test_phrases.npy')
    import pandas as pd
    list1 = []
    list2 = []
    for i in range(len(test_sets)):
        list1.append(i)
        res = cnn_model.predict(test_sets[i])
        print(res)
        list2.append(res)
