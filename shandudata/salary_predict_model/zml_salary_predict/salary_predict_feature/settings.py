...
# 输入文件路径
INPUT_PATH_0 = "{}/resume_educations_with_codes.parquet".format(HOME)
INPUT_PATH_1 = "{}/resume_works_zhimeli_locations.parquet".format(HOME)
INPUT_PATH_2 = '/data/datasets/salary_predict/university.csv'

OUTPUT_PATH = "{}/salary_predict_features.parquet".format(HOME)
