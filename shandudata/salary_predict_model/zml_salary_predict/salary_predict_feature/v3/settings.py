...
# 输入文件路径
INPUT_PATH_0 = "/user/hdfs/resume_educations_with_codes_v3.parquet"
INPUT_PATH_1 = "/user/hdfs/resume_works_zhimeli_locations_v3.parquet"
INPUT_PATH_2 = '/data/datasets/salary_predict/v3/university.csv'

OUTPUT_PATH = "salary_predict_features_v3.parquet".format(HOME)
